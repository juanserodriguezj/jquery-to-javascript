(async function load() {
  ...
  /* Ya logramos buscar peliculas, ahora necesitamos 
  mostrar el modal y en el informacion de la pelicula
  para este tenemos que hacer un filtrado en los datos
  de la pelicula pero antes tenemos que tener una forma
  de identificarlas y buscarlas. Por ejemplo el ID y
  y eso se lo asignamos como atributos a nuestros 
  elementos y al mismo tiempo nos sirve para hacer las
  busquedas en las listas de datos*/
